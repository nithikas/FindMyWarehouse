...
<div class="super_container">
	...
	<div class="home" style="height: 1000px;">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/warehouse.jpg" data-speed="0.8"></div>
		...
		<!-- This part contains the form that the user will input their information into for account creation. -->
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="contact_form_container">
							...
							<form action="created_account_sql.php" class="contact_form" id="contact_form" method = "post">
								<input type="text" name = "Name" class="contact_input" placeholder="Name" required="required">
								<input type="email" name = "EM" class="contact_input" placeholder="E-mail" required="required">
								<input type="password" name = "PW" class="contact_input" placeholder="Password" required="required">
								<input type="tel" name = "PN" class="contact_input" placeholder="Phone Number" required="required">
