				...
				<div class="row">
					<div class="col-lg-12">
						<div class="contact_form_container">
							...
							<button class="button contact_button" onclick="window.location = 'deleted_user.php?id=<?=$userID?>';"><span>Yes</span></button>				
							<button class="button contact_button" onclick="window.location = 'owner_portal.php?id=<?=$userID?>';"><span>No</span></button>
