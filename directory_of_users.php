...
<div class="super_container" style="overflow: auto;">
	...
	<div class="home" style="margin-top:0px;">
		...
		<div class="home_background" style="background-color: #e0f2fb"> 
			<div class="" style="background-color: #e0f2fb; margin:100px 100px 100px 100px; padding : 100px;">
				<div class="row">
					<div class="row">
		...
		<div class = "main">
				...
				<!-- send a query to the database to get all the information regarding the given user ID and output it into a table -->
									...
									<?php 
										...
										$sql = "SELECT User_ID, Name, Email FROM User Where User_ID = '$id'";
