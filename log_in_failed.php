				...
				<a href="main_page.php">
					<div class="logo_container d-flex flex-row align-items-start justify-content-start">
						...
						<div class="logo_content">
							<div class="logo_text logo_text_not_ie">Findmywarehouse.com</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="contact_form_container">
							<div class="contact_form_title">Log In <p style="color:red;">Login credentials invalid. Please try again.</p> </div>
							
							<form action="owner_portal.php" class="contact_form" id="contact_form" method = "post">
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_about">
							<div>
								<a href="main_page.php">
									<div class="logo_container d-flex flex-row align-items-start justify-content-start">
										<div class="logo_image"><div><img src="images/logo.png" alt=""></div></div>
										<div class="logo_content">
											<div style="font-size:24px" id="logo_text" class="logo_text logo_text_not_ie">Findmywarehouse.com</div>
											<div class="logo_sub"><?php echo "Today is " . date("l, F d, Y"); ?> - West Lafayette, IN</div>
										</div>
									</div>
								</a>	
							...
							<div class="footer_about_text">
								<p>Findmywarehouse.com is an online platform where people share their storage resources nationwide.</p>
							</div>
						</div>
					</div>
