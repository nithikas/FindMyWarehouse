...
<html lang="en">
<head>
<title>Log In to Request a Lease</title>
<meta charset="utf-8">
...
<?php
//gets necessary IDs from warehouse listing to pass information through new contract form 
$OwnerID = $_GET["oid"];  
$WarehouseID = $_GET["wid"]; 
?>
<!-- Login Section -->

<!-- each user is prompted to re-login so we can store their information to ensure
all required fields are filled with the correct data when uploading to the database -->
		<div class="home_content_container">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="contact_form_container">
							<div class="contact_form_title">Log In to Request a Lease</div>
							<form action="log_in_request_sql.php" class="contact_form" id="contact_form" method = "POST">
								
								Email: <input type="email" class="contact_input" placeholder="E-mail" required="required" name="email"><br>
								
								Password: <input type="password" class="contact_input" placeholder="Password" required="required" name = "userPassword"><br>
								
								<input type = "hidden" id = "WID" name="WID" value=<?=$WarehouseID?>>
