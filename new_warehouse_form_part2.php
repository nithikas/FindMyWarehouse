									...
									<div>
										<a href="main_page.php">
											<div class="logo_container d-flex flex-row align-items-start justify-content-start">
												<div class="logo_image"><div><img src="images/logo.png" alt=""></div></div>
												<div class="logo_content">
													<div id="logo_text" class="logo_text logo_text_not_ie">Findmywarehouse.com</div>
													<div class="logo_sub"><?php echo "Today is " . date("l, F d, Y"); ?> - West Lafayette, IN</div>
												</div>
											</div>
										</a>	
					...
					<div class="col-lg-12">
						<div class="contact_form_container">
							...
							<form action = "new_warehouse.php" class="contact_form" id="contact_form" method = "POST">
								<?php $SAvar = urldecode($_GET['SA']); $Stvar = urldecode($_GET['St']) ?>
								<input type="text" name = "OID" class="contact_input" value = <?=$_GET['OID'] ?> required="required">
								<input type="text" name = "SA" class="contact_input" value = "<?echo $SAvar ?>" required="required">
								<input type="text" name = "Ci" class="contact_input" value = <?=$_GET['Ci'] ?> required="required">
								<select name="St" class="contact_input" required="required">
									<option value="<?=$Stvar ?>"><?=$Stvar ?></option>
								...
								<input type="text" name = "ZC" class="contact_input" value = <?=$_GET['ZC'] ?> required="required">
								<input type="text" name = "TSAfR" class="contact_input" value = <?=$_GET['TSAfR'] ?> required="required">
								<font color = "red">*Our data tells us that your warehouse may be more successful if you lower your price. Would you like to change the price?</font><br>
								<input type="text" name = "PPSF" class="contact_input"value = <?=$_GET['PPSF'] ?> required="required">
								<input type="text" name = "YB" class="contact_input" value = <?=$_GET['YB'] ?> required="required">
								<select name = "PT" class="contact_input" value = <?=$_GET['PT'] ?> required="required">
