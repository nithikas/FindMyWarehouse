...
$servername = "mydb.ics.purdue.edu";
	...
	$query1 = "select Name, Email, Phone Number from User where User_ID = '$userID'";
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="contact_form_container">
							<div class="contact_form_title">Make A Payment</div>
							
							<form action="transaction_confirmation.php" class="contact_form" id="contact_form" method = "POST" ">
							<font color = "white"> 
							...
							Expiration Date: (format 12 / 29)<br>
							...
							<input type = "hidden" id = "contractID" name="contractID" value=<?=$contractID?>>
								...
								<button class="button contact_button"><span>Pay</span></button>				
							</form>
						</div>
					</div>
				</div>
