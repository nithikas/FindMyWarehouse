...
<div class="super_container">
	...
	<!-- Home -->
	<div class="home" style="height: 1200px;">
...
<!-- Citation for rating form style: 6. Savani H. Bootstrap star rating example using bootstrap-star-rating plugin [Internet]. Itsolutionstuff.com. 2018 [cited November 2018]. Available from: https://itsolutionstuff.com/post/bootstrap-star-rating-example-using-bootstrap-star-rating-pluginexample.html-->
...
<div class="container">
	...
	<font size = +1 color = "black"> As a valued client of our service, your feedback is important to us. <br>Please submit an honest rating of your lessee. <br>Mouse over the rating titles to read more about the definition of the rating.<br>
	<!--Rating form for owner. Includes tool tip popups to describe the rating.-->
	<form action="rating_sql_madeby_owner.php" class="contact_form" id="contact_form" method = "GET">
   
	<h2>Rate the lessee of your contract: </h2>
    <label for="input-1" class="control-label" style="cursor:pointer;" title="A lessee's rating for courtesy should be based on their professionalism, attitude and friendliness. "> Courtesy:</label>
	<input id="input-1" name="OC" class="rating rating-loading" data-min="0" data-max="5" data-step="0.1" value="5">
	

    <br/>
    <label for="input-2" class="control-label" style="cursor:pointer;" title="A lessee's rating for Adherence to Contract should be based on their compliance with the terms outlined in the contract. A low rating would be warranted if the lessee violated their end of the contract in any situation. ">Adherence to Contract:</label>
    <input id="input-2" name="OATC" class="rating rating-loading" data-min="0" data-max="5" data-step="0.1" value="5">


    <br/>
    <label for="input-3" class="control-label" style="cursor:pointer;" title="A lessee's rating for Timeliness should be based on their responsiveness to communication regarding the contract, warehouse access and all other communication during the rental process. It should also reflect their timeliness in emergency situations, if applicable. ">Timeliness:</label>
    <input id="input-3" name="OT" class="rating rating-loading" data-min="0" data-max="5" data-step="0.1" value="5">
	
	<input type = "hidden" id="input-4" name="CID" value=<?=$ContractID?>>
	<input type = "hidden" id="input-5" name="UserID" value=<?=$UserID?>>
