...
<html lang="en">
<head>
<title>Update your Warehouse</title>
<meta charset="utf-8">
...
<?php
//gets necessary IDs from user portal to pass information to the next page 
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="contact_form_container">
							<div class="contact_form_title">Update your warehouse</div>
							<!-- form that has owner input values about their warehouse that they want to change -->
							<form action="updated_warehouse.php" class="contact_form" id="contact_form" method = "POST" ">
							<font color = "white"> 
							Listed Rental Price:<br>
							<input type="text" id = "price" name = "price" ><br>
							Year Built:<br>
							<input type="text" id = "yearBuilt" name = "yearBuilt" ><br>
							Total Space Available for Rent:<br>
							<input type="text" id = "spaceAvail" name = "spaceAvail" ><br>
							Property Type:<br>
							<input type="text" id = "typeP" name = "typeP"><br>
							
							<input type = "hidden" id = "userID" name="userID" value=<?=$userID?>>
							<input type = "hidden" id = "warehouseID" name="warehouseID" value=<?=$warehouseID?>>
								
								<button class="button contact_button"><span>Update</span></button>				
							</form>
						</div>
					</div>
				</div>
