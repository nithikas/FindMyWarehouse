...
<meta charset="utf-8">
  ...
  <!-- creates the search bar function in the top right -->
  <script>
  $(function() {
		...
		<div class="home_background" style="background-color: #e0f2fb"> 
			<div class="" style="background-color: #e0f2fb; margin:100px 100px; padding : 100px;">
				<div class="row">
					<div class="row">
		<div class = "main">
                        <!-- creates table that displays what warehouses that specific user owns -->
						<table id="example" class="display" style="width:100%">
                            <thead class = "table table-dark">
                                <tr>
                                    ...
                                    <th>Year Built</th>
                                    <th>Owner ID</th>
									<th>Update Warehouse Information</th>
                                </tr>
                            </thead>
                            <tbody>
									<?php 
										...
										//returns warehouse information for ones that the specified user owns
										$sql = "SELECT Owner_ID, City, State, Zip_Code, Total_Space_Available_for_Rent, Year_Built, Warehouse_ID FROM Warehouse where Owner_ID = '$id'";
										$result = $conn->query($sql);
										if ($result->num_rows > 0) {
											while($row = $result->fetch_assoc()) {
										?>
											<tr>
											<!-- gives user the ability to click on a button that shows the details of that website -->
												...
												<td><?=$row["Owner_ID"]?></td>	
												<!-- redirects user to a form that lets them update warehouse information -->
												<td><a href = "update_warehouse.php?warehouseID=<?=$row["Warehouse_ID"]?>&id=<?=$id?>">Click here to update</td>
											</tr>
										<?php
											}
										}
...
<!-- inserts the bottom search bar -->                               
							   <tr>
                                    ...
                                    <th>Year Built</th>
									<th>Owner ID</th>
									<th style="background-color:dark-gray;"></th>
                                </tr>
                            </tfoot>
                        </table>
		</div>
...
<!-- functions that create the top and bottom search bars -->
